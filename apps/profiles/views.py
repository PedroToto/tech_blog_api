...
from tech_blog_api.settings.develop import DEFAULT_FROM_EMAIL
...
class FollowAPIView(APIView):
    def post(self, request, user_id, format=None):
        try:
            ...
            message = f"Hi there, {user_profile.user.first_name} {user_profile.user.last_name} now follows you"

...
from .reading_time_engine import ArticleReadTimeEngine
...
class Article(TimeStampModel):
    ...
    banner_image = models.ImageField(verbose_name="Banner image", default="/profile_default.png")
    ...
    def estimated_reading_time(self):
        return ArticleReadTimeEngine.reading_time(self)
...
class ArticleView(TimeStampModel):
    ...
    def __str__(self):
        return f"{self.article.title} viewed by {self.user.first_name if self.user else 'Anonymous'} from {self.viewer_ip}"
